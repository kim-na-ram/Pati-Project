...
interface UserDAO {
    ...
    @Query("UPDATE user SET user_name=:user_name, game_name=:game_name, self_pr=:self_pr where email like :email")
    fun updateUserInfo(email : String, user_name : String, game_name : String?, self_pr : String?)
